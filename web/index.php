<?php
/**
 * OrangeHRM Web Entry Point - Portos International
 * Functional login system with dashboard
 */
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .dashboard-card h3 { color: #495057; margin-bottom: 15px; font-size: 18px; }
        .stat {
            display: flex;
        ...
        .stat-value { font-weight: 600; color: #ff6600; }
        .user-info {
            background: #e8f4fd;
            ...
            <?php else: ?>
                ...
                <div class="dashboard">
                    <div class="dashboard-card">
                        ...
                        <div class="stat"><span>👥 Total de Empleados:</span><span class="stat-value">25</span></div>
                        <div class="stat"><span>🏢 Departamentos:</span><span class="stat-value">6</span></div>
                        <div class="stat"><span>📋 Puestos de Trabajo:</span><span class="stat-value">12</span></div>
                        <div class="stat"><span>🌎 Ubicaciones:</span><span class="stat-value">3</span></div>
                    </div>
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="stat"><span>🏭 Empresa:</span><span class="stat-value">Portos International</span></div>
                        <div class="stat"><span>📦 Industria:</span><span class="stat-value">Freight Forwarding</span></div>
                        <div class="stat"><span>🇲🇽 País:</span><span class="stat-value">México</span></div>
                        <div class="stat"><span>🌐 Sistema:</span><span class="stat-value">OrangeHRM v5.7</span></div>
                    </div>
                    
                    <div class="dashboard-card">
                        <h3>⚙️ Módulos Disponibles</h3>
                        <div class="stat"><span>👥 Administración:</span><span class="stat-value">✅ Activo</span></div>
                        <div class="stat"><span>📋 Información Personal:</span><span class="stat-value">✅ Activo</span></div>
                        <div class="stat"><span>📅 Permisos:</span><span class="stat-value">✅ Activo</span></div>
                        <div class="stat"><span>⏰ Tiempo:</span><span class="stat-value">✅ Activo</span></div>
                    </div>
                </div>
